...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Teaching",
          description: "Teaching and mentorship activities.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Resume",
          description: "Academic resume and background.",
          section: "Navigation",
          handler: () => {
      ...
      },{id: "news-presented-scalable-carbon-accounting-for-the-automotive-supply-chain-at-the-ford-research-and-innovation-center-in-dearborn-michigan",
          title: 'Presented “Scalable Carbon Accounting for the Automotive Supply Chain” at the Ford Research...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=tLdOQQgAAAAJ", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/+1-734-489-4449", "_blank");
        },
      },{
      id: 'light-theme',
